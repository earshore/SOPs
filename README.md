...
> 本 README 已按当前稳定版本 `v3.0.4`、当前代码结构、`package.json` 脚本和部署文档重新核对。`docs/archive/` 与 `.kiro/specs/` 中的阶段性文档可作历史参考，不建议直接作为当前开发依据。
...
当前最新稳定版本是 `v3.0.4`（2026-07-06）。`v3.0.4` 聚焦 Sentry 监控、安全门禁、Deep Chat 搜索与线程 UI、本地化、PromptLab/Settings 体验、Keyword Hunter 可访问性、PPC 分析器状态保留、动态请求预算和 AI 翻译模型选择，累计带来以下面向运营的变化：
