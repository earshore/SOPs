...
> 本 README 已按当前发布版本 `v3.0.5-rc.3`、当前代码结构、`package.json` 脚本和部署文档重新核对。`docs/archive/` 与 `.kiro/specs/` 中的阶段性文档可作历史参考，不建议直接作为当前开发依据。
...
当前发布版本是 `v3.0.5-rc.3`（2026-07-12，release candidate）；`latest` 标签指向该版本。最新稳定 tag 仍是 `v3.0.5`。`v3.0.5-rc.3` 在 `v3.0.5-rc.2` 基础上聚焦应用中心总览与构建体验，带来以下面向运营和维护的变化：
