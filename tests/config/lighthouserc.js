...
export default {
  ci: {
    ...
    collect: {
      ...
      url: [
        'http://localhost:4173/',
        'http://localhost:4173/#/app-center/master-analysis/promptlab',
        'http://localhost:4173/#/app-center/master-analysis/ai-analysis',
        'http://localhost:4173/#/app-center/master-analysis/scraper',
      ],
