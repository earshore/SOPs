...
export const amzf_events = [
    ...
    // ==================== February (二月) ====================
    {
        id: 4, name: '情人节', nameEn: "Valentine’s Day", emoji: '<i class="fas fa-heart" style="color: #E91E63;"></i>', date: '2月14日', month: 2,
        countries: ['DE', 'FR', 'IT', 'ES', 'NL', 'PL', 'GB', 'SE'], type: 'holiday',
    ...
    {
        id: 5, name: '狂欢节', nameEn: 'Carnival', emoji: '<i class="fas fa-theater-masks" style="color: #9C27B0;"></i>', date: '2月-3月初', month: 2,
    ...
    // ==================== March (三月) ====================
    {
        id: 7, name: '国际妇女节', nameEn: "Women’s Day", emoji: '<i class="fas fa-venus" style="color: #FF69B4;"></i>', date: '3月8日', month: 3,
    ...
    {
        id: 8, name: '父亲节(意/西)', nameEn: "Father’s Day IT/ES", emoji: '<i class="fas fa-user-tie" style="color: #3F51B5;"></i>', date: '3月19日', month: 3,
    ...
    {
        id: 10, name: '母亲节(英国/爱尔兰)', nameEn: "Mother’s Day UK/IE", emoji: '<i class="fas fa-female" style="color: #F44336;"></i>', date: '3月15日', month: 3,
    ...
    {
        id: 12, name: '国王节', nameEn: "King’s Day", emoji: '<i class="fas fa-crown" style="color: #FF9800;"></i>', date: '4月27日', month: 4,
    ...
    {
        id: 13, name: '瓦尔普吉斯之夜', nameEn: 'Walpurgis Night', emoji: '<i class="fas fa-fire" style="color: #FF5722;"></i>', date: '4月30日', month: 4,
    ...
    // ==================== May (五月) ====================
    {
        id: 14, name: '劳动节', nameEn: 'Labour Day', emoji: '<i class="fas fa-hammer" style="color: #795548;"></i>', date: '5月1日', month: 5,
    ...
    {
        id: 16, name: '母亲节(德/意/荷/比)', nameEn: "Mother’s Day DE/IT/NL/BE", emoji: '<i class="fas fa-heart" style="color: #E91E63;"></i>', date: '5月10日', month: 5,
    ...
    {
        id: 17, name: '度假金发放', nameEn: 'Holiday Money', emoji: '<i class="fas fa-coins" style="color: #FFD700;"></i>', date: '5月中-6月', month: 5,
    ...
    {
        id: 19, name: '母亲节(波兰)', nameEn: "Mother’s Day PL", emoji: '<i class="fas fa-heart" style="color: #E91E63;"></i>', date: '5月26日', month: 5,
    ...
    // ==================== June (六月) ====================
    {
        id: 21, name: '父亲节(法/荷/英/爱)', nameEn: "Father’s Day FR/NL/GB/IE", emoji: '<i class="fas fa-beer" style="color: #FFC107;"></i>', date: '6月21日', month: 6,
    ...
    {
        id: 22, name: '仲夏节', nameEn: 'Midsummer', emoji: '<i class="fas fa-sun" style="color: #FF9800;"></i>', date: '6月20-21日', month: 6,
    ...
    {
        id: 23, name: '父亲节(波兰)', nameEn: "Father’s Day PL", emoji: '<i class="fas fa-tools" style="color: #607D8B;"></i>', date: '6月23日', month: 6,
        countries: ['PL'], type: 'holiday',
    ...
    {
        id: 24, name: '夏季大促', nameEn: 'Summer Sales', emoji: '<i class="fas fa-tags" style="color: #F44336;"></i>', date: '6月底-8月', month: 6,
        countries: ['FR', 'IT', 'ES'], type: 'shopping',
    ...
    {
        id: 26, name: '法国国庆日', nameEn: 'Bastille Day', emoji: '<i class="fas fa-flag" style="color: #0055A4;"></i>', date: '7月14日', month: 7,
    ...
    // ==================== August (八月) ====================
    {
        id: 27, name: '圣母升天节', nameEn: 'Assumption Day', emoji: '<i class="fas fa-church" style="color: #9E9E9E;"></i>', date: '8月15日', month: 8,
    ...
    {
        id: 28, name: '返校季', nameEn: 'Back to School', emoji: '<i class="fas fa-school" style="color: #FFC107;"></i>', date: '8月中-9月初', month: 8,
    ...
    // ==================== September (九月) ====================
    {
        id: 29, name: '儿童节(德/荷)', nameEn: 'Children’s Day DE/NL', emoji: '<i class="fas fa-child" style="color: #4CAF50;"></i>', date: '9月20日/25日', month: 9,
    ...
    // ==================== October (十月) ====================
    {
        id: 31, name: '德国统一日', nameEn: 'German Unity Day', emoji: '<i class="fas fa-star" style="color: #FFD700;"></i>', date: '10月3日', month: 10,
        countries: ['DE'], type: 'holiday',
    ...
    {
        id: 32, name: '万圣节', nameEn: 'Halloween', emoji: '<i class="fas fa-ghost" style="color: #607D8B;"></i>', date: '10月31日', month: 10,
    ...
    // ==================== November (十一月) ====================
    {
        id: 33, name: '诸圣节', nameEn: 'All Saints Day', emoji: '<i class="fas fa-cross" style="color: #795548;"></i>', date: '11月1日', month: 11,
        countries: ['FR', 'IT', 'ES', 'PL'], type: 'holiday',
    ...
    {
        id: 35, name: '光棍节', nameEn: 'Singles Day', emoji: '<i class="fas fa-shopping-bag" style="color: #E91E63;"></i>', date: '11月11日', month: 11,
    ...
    {
        id: 36, name: '儿童节(法/意/西)', nameEn: 'Children’s Day South EU', emoji: '<i class="fas fa-child" style="color: #FFC107;"></i>', date: '11月20日', month: 11,
    ...
    {
        id: 39, name: '圣尼古拉斯节', nameEn: 'St. Nicholas/Sinterklaas', emoji: '<i class="fas fa-gift" style="color: #D32F2F;"></i>', date: '12月5-6日', month: 12,
    ...
    {
        id: 40, name: '圣卢西亚节', nameEn: 'St. Lucia Day', emoji: '<i class="fas fa-fire" style="color: #FF9800;"></i>', date: '12月13日', month: 12,
    ...
    {
        id: 41, name: '圣诞节', nameEn: 'Christmas', emoji: '<i class="fas fa-tree" style="color: #2E7D32;"></i>', date: '12月25日', month: 12,
        countries: ['DE', 'FR', 'IT', 'ES', 'NL', 'PL', 'GB', 'SE'], type: 'holiday',
    ...
    {
        id: 42, name: '节礼日', nameEn: 'Boxing Day', emoji: '<i class="fas fa-box" style="color: #8D6E63;"></i>', date: '12月26日', month: 12,
    ...
    {
        id: 43, name: '跨年夜', nameEn: 'New Year Eve', emoji: '<i class="fas fa-glass-cheers" style="color: #E91E63;"></i>', date: '12月31日', month: 12,
        countries: ['DE', 'FR', 'IT', 'ES', 'NL', 'PL', 'GB', 'SE'], type: 'holiday',
