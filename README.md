...
> 本 README 已按当前待发布版本 `v3.0.4-rc.6`、当前代码结构、`package.json` 脚本和部署文档重新核对。`docs/archive/` 与 `.kiro/specs/` 中的阶段性文档可作历史参考，不建议直接作为当前开发依据。
...
当前待发布版本是 `v3.0.4-rc.6`（2026-07-09，release candidate）；最新稳定 tag 是 `v3.0.4`。`v3.0.4-rc.6` 聚焦 App Center 删除确认弹窗（Deep Chat 与 Keyword Hunter 快照），以主题化弹窗替换原生 confirm、支持取消/Esc/遮罩关闭与「不再询问」持久化，延续 `v3.0.4` 的运营作业系统收敛，带来以下面向运营和维护的变化：
