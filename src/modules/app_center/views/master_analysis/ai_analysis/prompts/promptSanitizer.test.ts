...
describe("sanitizePromptInputArray", () => {
  it("should return empty array for invalid input", () => {
    expect(
      sanitizePromptInputArray(null as unknown as PromptInputArray),
    ).toEqual([]);
    expect(
      sanitizePromptInputArray(undefined as unknown as PromptInputArray),
    ).toEqual([]);
    expect(
      sanitizePromptInputArray("not an array" as unknown as PromptInputArray),
    ).toEqual([]);
  });
...
describe("validateAIOutput", () => {
  it("should return invalid for empty output", () => {
    ...
    expect(validateAIOutput(undefined as unknown as AIOutput).isValid).toBe(
      false,
    );
  });
  ...
  it("should accept normal text responses", () => {
    const normalText =
      "This is a normal analysis result with product information.";
