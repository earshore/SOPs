...
export const SAMPLE_ANALYSIS_REPORT: FullAnalysisReport = {
  ...
  'vocab-gap': {
    ...
    buyer_terms: [
      "smell", "great", "super", "scam", "expensive", "doesn't stay",
      "good", "bon", "amount", "perfume"
    ],
    uncovered_buyer_terms: [
      {
        term: "scam",
  ...
  'promise-reality': {
    ...
    overall_credibility: {
      score: "5/10",
      assessment: "Listing存在明显的过度承诺问题，特别是持久时间和品牌信誉方面。香味品质是唯一获得一致验证的卖点。建议大幅修订关键承诺以重建用户信任。"
    },
