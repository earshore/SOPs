        ...
        items: [
          {
            key: '操作入口',
            value:
              '优先看 Seller Central 中的 Deals Dashboard，以后台 eligibility、费用和日期窗口为准。',
          },
          {
            key: '适用目标',
            value: '冲排名、冲销量、承接大促会场流量，或为重点关键词打短周期权重。',
          },
          {
            key: '核心门槛',
            value: '历史价格校验、库存覆盖、评分、图文质量、站点资格，缺一个都会影响提报价值。',
          },
        ...
        items: [
          {
            ...
            text: '只把 Deals 给 1-3 个主推 ASIN，用来打关键词和排名，而不是平均分给所有 SKU。',
            tags: ['success'],
          },
          {
            icon: 'fa-check-circle',
            text: '提报前同步锁库存、调广告预算、检查参考价和活动价，避免临门一脚失效。',
            tags: ['success'],
          },
          {
            icon: 'fa-times-circle',
            text: '不要为了“能报”硬报 Deal。报名费、深折扣和广告叠加后，常常会把净利打穿。',
            tags: ['danger'],
          },
        ],
      },
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            key: '前台入口',
            value: '搜索结果、详情页、优惠券聚合页面，适合承接站内自然流量和广告流量。',
          },
          {
            key: '费用模式',
            value: '通常按核销收费，具体费率和站点规则以后台实时提示为准，必须同步看预算上限。',
          },
          {
            key: '常见折扣',
            value: '日常 5%-15% 更稳妥，大促时再结合利润空间加深折扣，不建议无脑长期高折。',
          },
          {
            key: '运营建议',
            value: '必须设置预算、起止时间和复盘节点；高销量 ASIN 没有预算上限，容易把费用跑飞。',
          },
        ],
      },
      {
        ...
        items: [
          {
            icon: 'fa-check-circle',
            text: '广告在跑、转化还想再提一点时，Coupons 往往是第一优先级。',
            tags: ['success'],
          },
          {
            icon: 'fa-check-circle',
            text: '做大促预热时，可以先用 Coupons 观察折扣敏感度，再决定要不要上更重的工具。',
            tags: ['success'],
          },
          {
            icon: 'fa-times-circle',
            text: '不要把 Coupons 当成清库存主工具，费用会被核销拖高，尾货处理效率也未必最好。',
            tags: ['danger'],
          },
        ],
      },
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            key: '最佳场景',
            value: '成熟款常态提转化、大促会员承接、广告已经有流量但还想压榨详情页转化率。',
          },
          {
            key: '重点检查',
            value: '站点资格、价格校验、评分基础、库存深度，以及是否与现有折扣冲突。',
          },
          {
            key: '经营纪律',
            value: '成熟款可以常态化挂，但不要频繁开关或大幅波动折扣，容易打乱价格节奏。',
          },
          {
            key: '一句话判断',
            value: '如果你想提升 Prime 流量下的转化效率，它通常比硬上 Deal 更轻、更稳。',
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            key: '最佳场景',
            value: '配件带动主品、替换装拉件数、套装促单、站外合作码、老客复购。',
          },
          {
            key: '前台逻辑',
            value:
              '更多发生在详情页、购物车和结算逻辑中，对 CTR 帮助有限，但对客单价和连带率帮助明显。',
          },
          {
            key: '运营关键',
            value: '规则一定要简单，最好一句话能讲明白，否则用户理解成本高、转化不一定升。',
          },
          {
            key: '风险提醒',
            value: '赠品、折扣门槛和变体组合设置复杂时，最容易出现利润误判和前台理解偏差。',
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            key: '适用库存',
            value: '库龄高、销量持续下滑、补货失误导致积压、季节窗口已过的 FBA 库存。',
          },
          {
            key: '经营目标',
            value: '降低仓储费、回收现金流、腾出仓位给主推产品，而不是继续追求高毛利。',
          },
          {
            key: '不要怎么用',
            value: '不要把品牌形象款、长期主力款、还在上升期的产品轻易扔进 Outlet。',
          },
          {
            key: '实操提醒',
            value: '深折扣前先核算尾货回收底线，确保“尽快回款”不等于“盲目清仓”。',
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          [
            '新品冷启动',
            '小力度 Coupon / 轻 Price Discount',
            '配合广告验证转化',
            '评论和转化还没跑通就上 Deals',
          ],
          [
            '成熟款稳态提转化',
            'Prime 专享折扣 / Price Discounts',
            '视利润再叠小 Coupon',
            '长期高折把价格体系打乱',
          ],
          [
