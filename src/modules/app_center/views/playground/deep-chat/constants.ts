...
export const EMPTY_CHAT_WRAP_HEIGHT = 168;
export const MESSAGE_TOOLBAR_CLASS = 'playground-message-toolbar';
export const THREAD_RAIL_COLLAPSED_CLASS = 'is-rail-collapsed';
export const DEEP_CHAT_SCRIPT_MARKER = 'playground-deep-chat-element';
