...
**日期**: 2026-07-26（refresh · D2 long-tail **#6 deferred** · D6 #25 AppModal · #24 confirmModal · residual #18–23 · D12×24 · D8 type-check:tests）  
**范围**: `main` ahead of `sops/main`； residual 主题波 + D6 #24 confirmModal + **#25 AppModal** + **D2 #6 docs deferral**；settings WIP **不**入本轮  
...
| 层                 | 灯         | 一句话                                                                                                                                                                                                                                           |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Code / 契约**    | **Green**  | D6 #18–**25**（**#25 AppModal** primary soft chrome）· D12×**24** · D2 #2–#5 + **#6 deferred** · D8 soft · shell nav/settings focus |
...
**一句话**: residual #18–24 + **#25 AppModal** primary soft chrome 已落；D2 radius long-tail **#6 deferred — diminishing returns**；体验关闸仍只靠 **人工 XO**。smoke 用 `npm run test:e2e:smoke`（4173）。
...
```
be4329f1 style(theme): format confirmModal and D8 test guards  ← HEAD
...
- D6 #25 AppModal title/accent soft chrome → Appearance primary
- D12 scaffold **24**（+ PromptLab + Skills + NPI）@ `023b8952`
- D2 workbench radius long-tail #5 @ `b85cd597`；**#6 deferred** docs inventory @ HEAD
...
- **无** new D6 样本 beyond residual #18–25（本轮 **#25 AppModal**）
