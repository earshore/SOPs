...
describe("generateAnalysisPrompt - validation", () => {
  ...
  it("should throw error for invalid product", () => {
    expect(() => {
      generateAnalysisPrompt(
        "title-keywords",
        null as unknown as ProductArgument,
      );
    }).toThrow("无效的产品对象");
...
describe("generateAnalysisPrompt - language handling", () => {
  it("should support different languages", () => {
    const promptZh = generateAnalysisPrompt(
      "title-keywords",
      mockProduct,
      "zh",
    );
    const promptEn = generateAnalysisPrompt(
      "title-keywords",
      mockProduct,
      "en",
    );
    const promptDe = generateAnalysisPrompt(
      "title-keywords",
      mockProduct,
      "de",
    );
...
describe("generateBatchAnalysisPrompt", () => {
  ...
  it("should throw error for invalid task array", () => {
    expect(() => {
      generateBatchAnalysisPrompt(
        null as unknown as BatchTaskIdsArgument,
        mockProduct,
      );
    }).toThrow("无效的任务ID数组");
  });
