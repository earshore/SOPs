...
function validateRequiredMetadataFields(meta: Record<string, unknown>): BasicValidationResult | null {
...
function validateStrictMetadata(data: Record<string, unknown>, strictMetadata: boolean): ValidationResult | null {
