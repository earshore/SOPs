    ...
    it('should extract DNA from legacy underscore fields', () => {
      const report = {
        buyer_profile: {
          ...
          buyer_types: [
            { type: 'gift buyer', percentage_estimate: '40%', evidence: 'reviews' }
          ],
          usage_scenes: [],
        ...
        selling_points: {
          bullet_analysis: [
            {
              bullet_index: 1,
              original_text_summary: '50ml travel bottle, lasts 6小时, package size 10x5x3cm',
        ...
        title_seo_roots: {
          primary_keywords: [
            { keyword: 'travel perfume', weight: 'high', search_volume_estimate: 'high' }
          ],
          secondary_keywords: [
