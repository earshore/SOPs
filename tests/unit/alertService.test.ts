...
import { AlertLevel, AlertService, AlertType, createAlertService } from '@/services/alertService';
...
it('initializes default rules and triggers a matching alert', () => {
  ...
  expect(mockShowToast).toHaveBeenCalledWith(expect.stringContaining('LCP超过阈值'), {
    type: 'warning',
  });
