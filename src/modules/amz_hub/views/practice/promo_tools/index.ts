        ...
        items: [
          {
            ...
            style: "success",
            text: "库存充足再报秒杀，断货比不报更伤排名",
          },
          {
            icon: "fa-check-circle",
            style: "success",
            text: "提前2-3周报名，越早费用越低、时间段越好",
          },
          {
            icon: "fa-check-circle",
            style: "success",
            text: "秒杀期间同步加大广告预算，形成流量叠加",
          },
          {
            icon: "fa-times-circle",
            style: "danger",
            text: "新品0评论不要报秒杀，转化率太低，浪费钱",
          },
          {
            icon: "fa-times-circle",
            style: "danger",
            text: "不要在淡季报秒杀，自然流量太少效果差",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            text: "提前3个月：分析去年Prime Day数据，确定主推产品",
            done: true,
          },
      ...
      },
      {
        ...
        items: [
          {
            icon: "fa-chart-line",
            text: "我的经验：Prime Day期间日均销量是平时的 3-5倍，广告ACOS反而下降15-20%",
          },
          {
            icon: "fa-trophy",
            text: '核心策略：用Prime Day的高转化"养"关键词排名，这个权重会延续1-2个月',
          },
        ],
      },
      {
        ...
        items: [
          {
            icon: "fa-check-circle",
            style: "success",
            text: "创建文具套装Bundle，客单价+利润率都更高",
          },
          {
            icon: "fa-check-circle",
            style: "success",
            text: '在Listing标题中加入"Back to School"关键词',
          },
          {
            icon: "fa-check-circle",
            style: "success",
            text: "大学新生宿舍用品是蓝海：收纳盒、床品、小家电",
          },
          {
            icon: "fa-times-circle",
            style: "danger",
            text: "不要和大品牌硬刚书包/文具主词，广告成本太高",
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          {
            icon: "fa-fire",
            text: "我的经验：BFCM期间单日销量可达平时的 8-15倍，是全年利润的主要来源",
          },
          {
            icon: "fa-lightbulb",
            text: '核心技巧：BFCM前维持适当高价，才能在BFCM时做出"大幅折扣"的视觉效果',
          },
        ],
      },
      {
                    ...
                    <div class="amzpt_timeline" style="margin: 20px 0; position: relative; padding-left: 30px;">
                        ...
                        ${(block.items || [])
                          .map((item) => {
                            ...
                            const color =
                              levelColors[item.level as string] || "#666";
                            return `
