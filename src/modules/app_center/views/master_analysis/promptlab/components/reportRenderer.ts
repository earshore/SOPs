  ...
  return `
    <div class="dimension-header p-3 bg-slate-50 cursor-pointer hover:bg-slate-100 transition-colors"
      ...
      <div class="flex items-center gap-3">
        <input type="checkbox"
               class="dimension-checkbox h-4 w-4 rounded border-slate-300 text-[var(--color-primary,#3b82f6)] focus:ring-[var(--color-primary,#3b82f6)] cursor-pointer"
  ...
  return `
    <div class="sub-item-wrapper mb-2">
      <div class="sub-item flex items-center gap-2 py-2 hover:bg-slate-50 rounded px-2 transition-colors"
        ...
        <input type="checkbox"
               class="sub-item-checkbox h-3.5 w-3.5 rounded border-slate-300 text-[var(--color-primary,#3b82f6)] focus:ring-[var(--color-primary,#3b82f6)] cursor-pointer"
...
function renderSelectableContentItem(
  ...
  return `
    <div class="content-item flex items-start gap-2 py-1.5 px-2 hover:bg-slate-50 rounded text-xs">
      <input type="checkbox"
             class="content-item-checkbox h-3 w-3 rounded border-slate-300 text-[var(--color-primary,#3b82f6)] focus:ring-[var(--color-primary,#3b82f6)] cursor-pointer mt-0.5 shrink-0"
    ...
    const template = `
      <div class="flex h-5 items-center">
        <input type="checkbox"
               ...
               class="h-4 w-4 rounded border-slate-300 text-[var(--color-primary,#3b82f6)] focus:ring-[var(--color-primary,#3b82f6)] cursor-pointer"
               ${isChecked ? 'checked' : ''}
