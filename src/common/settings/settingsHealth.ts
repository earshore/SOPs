// src/common/settings/settingsHealth.ts
// Shared pure settings-health helpers. Kept outside components/settings so
// non-settings callers (e.g. home AI status) can reuse them without violating
// the AC-6 dependency direction (sections/domain imported only from the shell
