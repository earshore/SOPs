...
**Out of scope for this sprint (document, do not implement):** Chat Completions CRUD (List/Get/Update/Delete stored completions), Realtime, Batch, Fine-tune, Assistants.
