...
> 本 README 已按最新远端 tag `v3.0.3-rc.8`、当前代码结构、`package.json` 脚本和部署文档重新核对。`docs/archive/` 与 `.kiro/specs/` 中的阶段性文档可作历史参考，不建议直接作为当前开发依据。
...
当前最新 tag 是 `v3.0.3-rc.8`（2026-06-12，release candidate）；最新稳定 tag 是 `v3.0.2`。`v3.0.3-rc.8` 聚焦 UI 质量审计、页面进入动效和报告渲染一致性，`v3.0.3` 系列累计带来以下面向运营的变化：
